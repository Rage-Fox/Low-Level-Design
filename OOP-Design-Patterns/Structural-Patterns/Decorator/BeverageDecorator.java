/*
The decorator pattern is a structural design pattern that lets you attach new behaviors to objects by encapsulating these objects inside wrapper classes that contain these behaviors.
It's useful when we need to add responsibilities to individual objects dynamically without affecting other objects.
Some languages even have decorators built-in as native features.
*/
